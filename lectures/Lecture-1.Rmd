...
**Important:** within an R file, you can use the # sign to add comments. Anything written after the # is *not* interpretted when you run the code.
...
Let's get more specific. Say we took a bunch of measurements of temperature in Fahranheit, but want to convert them. How might we do it?
